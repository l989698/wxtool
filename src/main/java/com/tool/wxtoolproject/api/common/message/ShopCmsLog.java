...
public class ShopCmsLog {
    ...
    public static void setServerName(String serverName) {
        ShopCmsLog.serverName = serverName;
    }
    ...
    public String toString() {
        ...
        builder.append(replaceTabAndEnter(ShopCmsLog.serverName)).append(TAB);
        builder.append(replaceTabAndEnter(ShopCmsLog.serverIp)).append(TAB);
