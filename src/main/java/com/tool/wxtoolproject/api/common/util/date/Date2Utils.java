...
/**
 * java8的时间计算工具类
 * Created by TianTianLi on 下午3:20 2017/11/23.
 */
...
//    private static final Logger logger = LoggerFactory.getLogger(DateUtil.class);
     ...
     * @return LocalDateTime
     */
    public static LocalDateTime dateToLocalDateTimeByFormat(Date date,String format) {
        LocalDateTime localDateTime = dateToLocalDateTime(date);
        String localDateTimeStr = formatLocalDateTimeToString(localDateTime,DATE_FMT_3)+" 00:00:00";
        localDateTime = stringToLocalDateTime(localDateTimeStr,format);
        return localDateTime;
    }
...
//        LocalDateTime creatTime= Date2Utils.stringToLocalDateTime("2018-06-03 12:00:45","yyyy-MM-dd");//获取拒绝最新的时间
        LocalDateTime localDateTime = Date2Utils.stringToLocalDateTime("2018-06-01"+" 00:00:00","yyyy-MM-dd HH:mm:ss");
        //获取当前时间
        LocalDateTime nowDate = Date2Utils.getCurrentLocalDateTime();
//            Date dateResult = DateCompareUtils.dayAddAndSub(Calendar.DATE, -30); //获取系统时间的前30天
        //获取两个日期之前相差的天数
        int days = Date2Utils.getAbsTimeDiffDay(nowDate,localDateTime);
